...
const OnlineDoors = () => {
    ...
    const listenDoorByIP = (doorId) => {
        const socket = socketIOClient(ip);
        socket.on(doorId, data => {
            setOnlineImages(prevState => ({...prevState, doorId: data}))
        });
    };
///////////////////////////////////////
    ...
    //////////////////////////////////////
    useEffect(() => {
        doorIds.forEach((doorId) => listenDoorByIP(doorId));
    }, []);
/////////////////////////////////////////////////
            ...
            <div className={`online_doors_body ${isDarkMode && 'darkModeBackground'}`}>
                {
                    doorIds.map((doorId) => <div className="online_doors_info_content">
                        ...
                        <div className={`online_doors_info_title ${isDarkMode && 'darkModeBackground'}`}>
                            ...
                            <h3 className={`${isDarkMode && 'darkModeColor'}`}>{doorId.door_name}</h3>
                        </div>
                ...
                {/*                                </div>*/}
                {/*                                <div*/}
                {/*                                    className={`doors_right_box ${isDarkMode && 'darkModeColor'}`}>{onlineImg3 && onlineImg3.user_in_db && onlineImg3.user_in_db.rank}</div>*/}
                {/*                            </div>*/}
                {/*                            <div className="label_box">*/}
                {/*                                <div*/}
                {/*                                    className={`doors_right_label ${isDarkMode && 'darkModeColor'}`}>{t("Lavozimi")}:*/}
                {/*                                </div>*/}
                {/*                                <div*/}
                {/*                                    className={`doors_right_box ${isDarkMode && 'darkModeColor'}`}>{onlineImg3 && onlineImg3.user_in_db && onlineImg3.user_in_db.user_type}</div>*/}
                {/*                            </div>*/}
                {/*                        </div>*/}
                {/*                        <div className="img_box">*/}
                {/*                            <img className="door_user_img"*/}
                ...
                {/*                        </div>*/}
                {/*                        <div*/}
                {/*                            className={`doors_right_box ${isDarkMode && 'darkModeColor'}`}>{onlineImg3 && onlineImg3.user_in_db && onlineImg3.user_in_db.access_type}</div>*/}
                {/*                    </div>*/}
                {/*                    <div className="limit_info">*/}
                {/*                        <div className="limit_info_top">*/}
                {/*                            <img className="limit_info_top_img" src={warning} alt=""/>*/}
                ...
                {/*                                </div>*/}
                {/*                                <div*/}
                {/*                                    className={`doors_right_box ${isDarkMode && 'darkModeColor'}`}>{onlineImg4 && onlineImg4.user_in_db && onlineImg4.user_in_db.rank}</div>*/}
                {/*                            </div>*/}
                {/*                            <div className="label_box">*/}
                {/*                                <div*/}
                {/*                                    className={`doors_right_label ${isDarkMode && 'darkModeColor'}`}>{t("Lavozimi")}:*/}
                {/*                                </div>*/}
                {/*                                <div*/}
                {/*                                    className={`doors_right_box ${isDarkMode && 'darkModeColor'}`}>{onlineImg4 && onlineImg4.user_in_db && onlineImg4.user_in_db.user_type}</div>*/}
                {/*                            </div>*/}
                {/*                        </div>*/}
                {/*                        <div className="img_box">*/}
                {/*                            <img className="door_user_img"*/}
                ...
                {/*                        </div>*/}
                {/*                        <div*/}
                {/*                            className={`doors_right_box ${isDarkMode && 'darkModeColor'}`}>{onlineImg4 && onlineImg4.user_in_db && onlineImg4.user_in_db.access_type}</div>*/}
                {/*                    </div>*/}
                {/*                    <div className="limit_info">*/}
                {/*                        <div className="limit_info_top">*/}
                {/*                            <img className="limit_info_top_img" src={warning} alt=""/>*/}
